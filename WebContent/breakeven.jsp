	...
	if(!i.hasNext())
		{
			...
			<div class="row">
				...
				<div class="col-sm-1 col-md-1 col-lg-1"></div>
				<%if(c.getVerification()=="yes") { %><a href="breakeven.jsp?name=<%=c.getCId() %>"><div class="col-sm-2 col-md-2 col-lg-2"><%=c.getName() %></div></a><%} else { %><div class="col-sm-2 col-md-2 col-lg-2"><%=c.getName() %></div><%} %>
				<div class="col-sm-1 col-md-1 col-lg-1"></div>
